...
public class GoogleProviderTests {
    ...
    private OrchestratorProviderAuthenticationDetails getCredentialsObject(){
        ...
        authenticationDetails.setName("checkGoogleCredential");
        authenticationDetails.setAdapterImplementation("eu.orchestrator.adapter.gcc.GCCAdapter");
        authenticationDetails.setAdapterType("Google");
        authenticationDetails.setProject(System.getProperty("gcp.project", ""));
        authenticationDetails.setUsername(System.getProperty("gcp.clientEmail", ""));
        authenticationDetails.setPrivateKey(System.getProperty("gcp.privateKey", ""));
    ...
    public void checkGoogleCredential() {
        ...
        if (null != responseEntity && responseEntity.getStatusCode() == HttpStatus.OK) {
            ...
            try {
                ...
                System.out.println("checkGoogleCredential FAILED, can't create JSONObject");
                e.printStackTrace();
            }

            try {
                if (callbackJSON.getString("code").equals("SUCCESS")) {
                    System.out.println("checkGoogleCredential PASSED");
                    return;
                }
            } catch (JSONException e) {
                System.out.println("checkGoogleCredential FAILED, can't stringify the callbackJSON");
                e.printStackTrace();
            }
        }
        System.out.println("checkGoogleCredential FAILED");
    }

    @Test
//    @Ignore
    public void spawnGoogleSimpleInstance() {
...
//            System.out.println(responseEntity.getStatusCodeValue());
    ...
    @Test
//    @Ignore
    public void spawnGoogleInstance() {
...
//            System.out.println(responseEntity.getStatusCodeValue());
    ...
    @Test
//    @Ignore
    public void checkGoogleRemoveInstance() {
        String graphId = "CMSApp";
        String graphInstanceId = "konstheo";
        String componentNodeId = "phpMyAdmin";
        String componentNodeInstanceId = "phpMyAdmin";
...
//            System.out.println(responseEntity.getStatusCodeValue());
    ...
    @Test
    @Ignore
    public void checkGoogleGetInstances() {
