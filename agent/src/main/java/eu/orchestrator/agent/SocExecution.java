 ...
 * @date 9/6/20
 */
public class SocExecution extends Thread {
    ...
    //LOGGER
    private static final Logger LOGGER = Logger.getLogger(SocExecution.class.getName());

    public SocExecution(String graphHexId, String graphInstanceHexId, String componentNodeHexId, String componentNodeInstanceHexId,
    ...
    @Override
    public void run() {
        LOGGER.log(Level.INFO, "SOC Service thread started !!!");
